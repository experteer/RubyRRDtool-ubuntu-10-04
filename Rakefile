...
#Hoe.spec("RubyRRDtool-ubuntu-10-04", RUBY_RRDTOOL_VERSION) do |p|
Hoe.spec("RubyRRDtool-ubuntu-10-04") do |p|
  ...
  p.url = "https://github.com/experteer/RubyRRDtool-ubuntu-10-04"
